    ...
    return (
        ...
        <div className="carousel-inner" id='carousel'>
          ...
          <div className="carousel-item">
            <img src="https://source.unsplash.com/random/900×700/?Dosa" className="d-block w-100" style={{ filter:"brightness(30%)" }} alt="..." />
          </div>
          <div className="carousel-item">
          ...
          <div className="carousel-item">
            <img src="https://source.unsplash.com/random/900×700/?Potato" className="d-block w-100" style={{ filter:"brightness(30%)" }} alt="..." />
          </div>
          <div className="carousel-item">
            <img src="https://source.unsplash.com/random/900×700/?Dal" className="d-block w-100" style={{ filter:"brightness(30%)" }} alt="..." />
          </div>
        </div>
          ...
          <span className="visually-hidden">Next</span>
            ...
            <div className="container">{
                foodCat!==[]?foodCat.map((data)=>{
                    ...
                    {foodItem !==[]? foodItem.filter((item)=>(item.category===data.category) && (item.name.toLowerCase().includes(search.toLowerCase())))
                    .map(filterItems=>{
                       return(
